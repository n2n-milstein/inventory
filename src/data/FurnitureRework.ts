 ...
 * TODO: What about etc things like lamps, TVs, etc?
 */
export enum FClass {
  Chair = "Chair",
  Couch = "Couch",
...
class Physical {
  ...
  constructor(size: number, fclass: FClass, heavy: boolean) {
    this.class = fclass;
    this.size = size;
    this.heavy = heavy;
  }
...
export const Size = {
  ...
  Mattress: ["Smaller than Twin (baby)", "Twin/XL", "Full", "Queen", "King+"],
  BoxSpring: ["Smaller than Twin (baby)", "Twin/XL", "Full", "Queen", "King+"],
  BedFrame: ["Smaller than Twin (baby)", "Twin/XL", "Full", "Queen", "King+"]
};
...
export class Furniture {
  id: string;
  desc: string; // example: green recliner
  donor: Donor;
  physical: Physical;
  timing: Timing;
